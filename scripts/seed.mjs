...
const CUSTOMERS = [
  ...
  { name: 'Carol Davis', email: 'carol@example.com', subject: 'Billing discrepancy on invoice #1042', description: 'My invoice shows a different amount than what was agreed upon in the contract.', priority: 'Urgent', status: 'In Progress' },
  ...
  { name: 'Frank Lee', email: 'frank@example.com', title: 'Frank Lee', subject: 'Password reset email not received', description: 'Requested password reset multiple times but no email arrives. Checked spam folder.', priority: 'Urgent', status: 'Open' },
  ...
  { name: 'Jack Taylor', email: 'jack@example.com', subject: 'Mobile app crashes on startup', description: 'The mobile app crashes immediately on launch after the latest update. Using iOS 18.', priority: 'Urgent', status: 'In Progress' },
]
